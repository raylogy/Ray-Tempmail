...
const DEFAULT_SETTINGS: UserSettings = {
  ...
  googleClientId: '',
  gmailAccessToken: '',
  customDomains: ['raylanmail.com', 'temp-inbox.net', 'secure-proxy.io'], 
  activeDomain: 'raylanmail.com',
...
const App: React.FC = () => {
  ...
  const currentDomain = settings.activeDomain || 'raylanmail.com';
  ...
  useEffect(() => {
    refreshEmails(true);
  }, [username, currentDomain, refreshEmails]);
        ...
        <div className="p-6 space-y-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-bold tracking-tight text-white uppercase">RAYLAN MAIL</h1>
            </div>
