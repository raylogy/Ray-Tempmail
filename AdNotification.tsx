...
const ADS = [
  {
    ...
    description: "Butuh akun DigitalOcean dengan harga terjangkau? Masanto adalah solusinya. Siap pakai, aman, dan terpercaya.",
    price: "IDR 55K",
            ...
            <div className="flex justify-between items-start mb-2">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-500 font-mono">Masanto Official Store</p>
                </div>
              </div>
